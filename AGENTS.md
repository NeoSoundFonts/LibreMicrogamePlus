...
AI-generated code is based upon sources of unknown origins and may not be compatible with GPL license, or may introduce conflicting license terms if they include code from other projects.
...
Any pull request to this project will ask you to confirm that you are the author and that you are contributing your changes under the GPL license.